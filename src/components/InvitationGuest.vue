<template>
  ...
  <div v-else class="invitation-container">
    ...
    <div class="btn-container">
      ...
      <button @click="commitEmail" :disabled="isDisabled" :class="{ disabled: isDisabled, enabled: !isDisabled }" ref="button">Voir l'évènement</button>
    </div>
  </div>
</template>
  ...
  <script setup >
    ...
    const isDisabled = computed(() => formGuestStore.email.length < 1);
