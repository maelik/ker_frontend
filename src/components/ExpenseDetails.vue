    ...
    <div class="expense-details">
        ...
        <div class="expenseCard">
            <div class="description">
                <h3>{{ expenseInfo.description }}</h3>
                <p>ajouté par {{ expenseInfo.payerName }}</p>
                <p>{{ formatDate(expenseInfo.date) }}</p>
            </div>
            <div class="price">
                {{ expenseInfo.amount }}€
            </div>
        ...
        <h1>Participants</h1>
        <div v-for="(participant, index) in expenseInfo.ExpenseParticipants" :key="index" class="participant-card">
          <div class="description participant">
