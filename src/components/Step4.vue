      ...
      <div class="input-container">
        <TransitionForm>
          <div class="centered">
            ...
            <input :style="{ position: 'relative', bottom: `${inputPosition}px` }" v-model="formStore.location" placeholder="Adresse de l'événement" @blur="resetInputPosition" @focus="focusAction" @keyup.enter="nextStep"/>
          </div>
        </TransitionForm>
      </div>
