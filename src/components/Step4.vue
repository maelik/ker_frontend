<template>
  <div class="container-children">
      <div class="input-container">
        <TransitionForm>
          <div class="centered">
            <h2 :style="{ position: `${inputPositionDOM}`, bottom: `${titlePosition}px` }">L'adresse de ton évènement</h2>
            <input :style="{ position: `${inputPositionDOM}`, bottom: `${inputPosition}px`, width: `${widthInput}%` }" v-model="formStore.location" placeholder="Adresse de l'événement" @blur="resetInputPosition" @focus="focusAction" @keyup.enter="nextStep"/>
          </div>
        </TransitionForm>
      </div>
